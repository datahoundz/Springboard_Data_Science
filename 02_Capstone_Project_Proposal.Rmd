...
__DELIVERABLES__  
A paper and slide deck produced using RMarkdown laying out the problem, the analysis, conclusions and proposed areas of action. The paper, slide deck and all supporting code will be made available in a [GitHub repository](https://github.com/datahoundz/Springboard_Data_Science). Upon completion of the capstone project, I intend to develop interactive Shiny apps and Tableau visualizations that individuals and groups could access to explore the data independently.  
