...
This study focused on data related to guns and gun laws, but the broader issue is one of mental health. Doctors should be allowed to ask patients if they own guns. Government researchers should be able to conduct detailed studies of the epidemic character of gun deaths. Data should be tracked at all governmental levels and made available to the general public.  The _avoidable_ loss of 20,000 plus lives every year should not be ignored for political reasons.  
