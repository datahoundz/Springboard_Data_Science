...
Gun ownership data presents conflicting issues. The survey data acquired from the Bindal Injury Prevention article covers only the single year of 2013. This limits the ability to analyze shifts in state level gun ownership rates over time. Dr. Michael Siegel at the Boston University School of Public Health has developed a [proxy ownership metric](https://www.ncbi.nlm.nih.gov/pubmed/23956369) that has been calculated from 1980 to 2016. This data was acquired directly from Dr. Siegel and integrated into the analysis. However, the proxy measurement utilizes the firearm suicide rate in its calculation. As the firearm suicide rate is the dependent variable of interest in this study, this proxy measure was dropped from the analysis. Sharp discrepancies between Siegel's measure and the Kalesan 2013 survey results strongly supports the need for better data on this variable of interest.  

## Data Issues: State Firearm Laws  

The State Firearm Law database tracks 132 separate law variables over a twenty-plus year period. 
